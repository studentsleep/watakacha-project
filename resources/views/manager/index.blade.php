                ...
                <form method="GET" action="{{ route('manager.index') }}" class="row g-3 align-items-end">
                    <div class="col-md-3">
                        ...
                        <select name="table" class="form-select form-select-sm" onchange="this.form.submit()">
                            <option value="items" {{ $table=='items' ? 'selected' : '' }}>Items</option>
                            <option value="units" {{ $table=='units' ? 'selected' : '' }}>Units</option>
                            <option value="types" {{ $table=='types' ? 'selected' : '' }}>Types</option>
                        </select>
                    </div>
